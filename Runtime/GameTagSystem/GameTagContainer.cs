...
namespace DataKeeper.GameTagSystem
{
    ...
    public class GameTagContainer
    {
        ...
        public bool HasStartWith(GameTag gameTag) => _tags.Any(t => t.StartsWithAndNotEquals(gameTag));
        public bool HasStartWithOrEquals(GameTag gameTag) => _tags.Any(t => t.StartsWithOrEquals(gameTag));
        
        public IEnumerable<GameTag> GetTagsStartsWith(GameTag gameTag) => _tags.Where(t => t.StartsWithAndNotEquals(gameTag));
