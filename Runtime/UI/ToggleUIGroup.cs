...
namespace DataKeeper.UI
{
    ...
    public class ToggleUIGroup : UIBehaviour
    {
       [SerializeField] private bool m_AllowSwitchOff = false;
        ...
        protected List<ToggleUI> m_Toggles = new List<ToggleUI>();

        protected ToggleUIGroup()
        {}
        ...
        private void ValidateToggleIsInGroup(ToggleUI toggle)
        {
        ...
        public void NotifyToggleOn(ToggleUI toggle, bool sendCallback = true)
        {
        ...
        public void UnregisterToggle(ToggleUI toggle)
        {
        ...
        public void RegisterToggle(ToggleUI toggle)
        {
            if (!m_Toggles.Contains(toggle))
        ...
        public void EnsureValidState()
        {
            ...
            IEnumerable<ToggleUI> activeToggles = ActiveToggles();

            if (activeToggles.Count() > 1)
            {
                ToggleUI firstActive = GetFirstActiveToggle();

                foreach (ToggleUI toggle in activeToggles)
                {
        ...
        /// </remarks>
        public IEnumerable<ToggleUI> ActiveToggles()
        {
        ...
        /// </remarks>
        public ToggleUI GetFirstActiveToggle()
        {
            IEnumerable<ToggleUI> activeToggles = ActiveToggles();
